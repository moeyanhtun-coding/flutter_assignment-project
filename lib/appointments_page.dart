...
class _AppointmentsBodyState extends State<AppointmentsBody> {
  ...
  Future<void> _saveAppointments() async {
    ...
    // Convert Map<String, dynamic> to JSON strings
    List<String> appointmentJsonList = appointments.map((appointment) {
      return jsonEncode(appointment);
    }).toList();

    await prefs.setStringList('appointments', appointmentJsonList);
  }
